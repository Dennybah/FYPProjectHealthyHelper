...
public class PoachedPearsRecipe extends AppCompatActivity {
    ...
    public static final String poachedPearsRecipeState = "poachedPearsRecipeState";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recipe_poached_pears);

        //Adds custom toolbar to app screen
        Toolbar myToolbar = findViewById(R.id.toolBar);
        setSupportActionBar(myToolbar);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Poached Pears Recipe");
    ...
    private void addToCartButton(){
        ...
        SharedPreferences.Editor editor = poachedPearsStoredState.edit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.articlesMenuItem):
                intent = new Intent(PoachedPearsRecipe.this, ArticlesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.bloodRecorderMenuItem):
                intent = new Intent(PoachedPearsRecipe.this, BloodGlucoseRecorderMenu.class);
                startActivity(intent);
                return true;
            case (R.id.recipeMenuItem):
                intent = new Intent(PoachedPearsRecipe.this, RecipesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.shoppingCartMenuItem):
                intent = new Intent(PoachedPearsRecipe.this, ShoppingCartMenu.class);
                startActivity(intent);
                return true;
            case (R.id.homeMenuItem):
                intent = new Intent(PoachedPearsRecipe.this, MainMenu.class);
                startActivity(intent);
                return true;
            case (R.id.howToUse):
                intent = new Intent(PoachedPearsRecipe.this, HowToUseFeatures.class);
                startActivity(intent);
                return true;
            default:
