...
public class SalmonRiceBowlRecipe extends AppCompatActivity {
    ...
    public static final String salmonRiceBowlRecipeState = "salmonAndRiceRecipeState";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recipe_salmon_rice_bowl);

        //Adds custom toolbar to app screen
        Toolbar myToolbar = findViewById(R.id.toolBar);
        setSupportActionBar(myToolbar);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Salmon Rice Bowl Recipe");
    ...
    private void addToCartButton(){
        ...
        SharedPreferences.Editor editor = salmonRiceBowlStoredState.edit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.articlesMenuItem):
                intent = new Intent(SalmonRiceBowlRecipe.this, ArticlesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.bloodRecorderMenuItem):
                intent = new Intent(SalmonRiceBowlRecipe.this, BloodGlucoseRecorderMenu.class);
                startActivity(intent);
                return true;
            case (R.id.recipeMenuItem):
                intent = new Intent(SalmonRiceBowlRecipe.this, RecipesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.shoppingCartMenuItem):
                intent = new Intent(SalmonRiceBowlRecipe.this, ShoppingCartMenu.class);
                startActivity(intent);
                return true;
            case (R.id.homeMenuItem):
                intent = new Intent(SalmonRiceBowlRecipe.this, MainMenu.class);
                startActivity(intent);
                return true;
            case (R.id.howToUse):
                intent = new Intent(SalmonRiceBowlRecipe.this, HowToUseFeatures.class);
                startActivity(intent);
                return true;
            default:
