...
public class CrunchyBlueberryYogurtShoppingCart extends AppCompatActivity {
    ...
    public static final String blueberryYogurtIngredientsPressed = "BlueberryYogurtIngredientsPressed";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.shopping_cart_crunchy_blueberry_yogurt);

        //Adds custom toolbar to app screen
        Toolbar myToolbar = findViewById(R.id.toolBar);
        setSupportActionBar(myToolbar);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Crunchy Blueberry Yogurt");
    ...
    private void ingredientsPressed(){
        SharedPreferences ingredientsStoredState = getSharedPreferences(blueberryYogurtIngredientsPressed, 0);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.articlesMenuItem):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, ArticlesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.bloodRecorderMenuItem):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, BloodGlucoseRecorderMenu.class);
                startActivity(intent);
                return true;
            case (R.id.recipeMenuItem):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, RecipesMenu.class);
                startActivity(intent);
                return true;
            case (R.id.shoppingCartMenuItem):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, ShoppingCartMenu.class);
                startActivity(intent);
                return true;
            case (R.id.homeMenuItem):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, MainMenu.class);
                startActivity(intent);
                return true;
            case (R.id.howToUse):
                intent = new Intent(CrunchyBlueberryYogurtShoppingCart.this, HowToUseFeatures.class);
                startActivity(intent);
                return true;
            default:
